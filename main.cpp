...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	vertexResourceDesc.Width = sizeof(MyBase::Vector4) * 3;			// リソースのサイズ。今回はVector4を3頂点分
	// バッファの場合はこれらは1にする決まり
	...
	// 使用するリソースのサイズは頂点
	vertexBufferView.SizeInBytes = sizeof(MyBase::Vec4) * 3;
	// 1頂点あたりのサイズ
	vertexBufferView.StrideInBytes = sizeof(MyBase::Vec4);

	// 頂点リソースにデータを書き込む
	MyBase::Vec4* vertexData = nullptr;
	// 書き込むためのアドレス
